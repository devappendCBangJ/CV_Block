...
parser.add_argument('--base-path', default='/media/hi/SK Gold P31/Capstone/GolfBall/Golfball_Near', type=str, help='Base 폴더 경로 지정')
parser.add_argument('--json-filenames', default=['instances_train2017.json', 'instances_val2017.json'], type=str, help='')
