...
# 0. 변수 정의
# ==============================================================
parser = argparse.ArgumentParser(description='2_YOLOv5_Only_Image_File_Split_Copy')

parser.add_argument('--base-path', default='/media/hi/SK Gold P31/Capstone/BG-20k/train', type=str, help='Data Split할 폴더 경로 지정')
parser.add_argument('--base-split-path', default='/media/hi/SK Gold P31/Capstone/BG-20k/train_split', type=str, help='Split 데이터셋을 저장할 폴더 경로 지정')
...
parser.add_argument('--test-size', default=400, type=int, help='test data 개수')
...
# --------------------------------------------------------------
# (2) Data Split 함수 정의
def split_dataset(image_filenames, train_size, val_size, test_size):
...
# (1) Data Split
split_dataset(image_filenames, train_size=args.train_size, val_size=args.val_size, test_size=args.test_size)