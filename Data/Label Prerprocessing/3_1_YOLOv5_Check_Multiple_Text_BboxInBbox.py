...
# 0. 변수 정의
# ==============================================================
parser = argparse.ArgumentParser(description='3_1_YOLOv5_Check_Multiple_Text_BboxInBbox')
...
# 1. 비정상 Label 추출
# ==============================================================
def label_bboxinbbox_error_check():
    # --------------------------------------------------------------
